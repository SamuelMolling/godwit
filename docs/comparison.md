...
| CI/CD | composite GitHub Action (lint, plan, migrate, dry run, sticky comment), ArgoCD hook Jobs, Helm chart | Docker image, various actions | Docker image, GitHub Action | `atlas-action` |
