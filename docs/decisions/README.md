...
| [0024](0024-the-api-publishes-only-what-it-classified.md) | The API publishes only the errors it classified; everything else is redacted | #PR |
| [0025](0025-a-revert-from-a-comment-is-held-to-the-same-people-as-the-apply.md) | A revert from a comment is held to the same people as the apply, and may not remove a gate | #PR |
