...
internal/admission/    what a submission becomes on a target and whether it runs: version target, gates, plan binding
internal/surface/      what godwit is reached over: api/ (connect handlers, bearer-token interceptor), githubapp/, ui/
